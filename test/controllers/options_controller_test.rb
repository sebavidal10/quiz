...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { content: @option.content, is_correct: @option.is_correct, position: @option.position, question_id: @option.question_id } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { content: @option.content, is_correct: @option.is_correct, position: @option.position, question_id: @option.question_id } }
